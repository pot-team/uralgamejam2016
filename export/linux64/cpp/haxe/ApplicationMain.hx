...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Pot-Team", "uralgamejam2016", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "uralgamejam2016";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "uralgamejam2016", null, { width: 1280, height: 720 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "391",
			company: "Pot-Team",
			file: "uralgamejam2016",
			fps: 60,
			name: "uralgamejam2016",
			orientation: "",

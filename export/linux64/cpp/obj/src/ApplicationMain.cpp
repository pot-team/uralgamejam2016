...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("Pot-Team","\xd5","\x01","\xd3","\x69"),HX_HCSTRING("uralgamejam2016","\xbf","\xe7","\xa5","\xee"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(130)
		...
		HX_STACK_LINE(49)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)1280,(int)720,(int)60,(int)0,tmp22,HX_HCSTRING("uralgamejam2016","\xbf","\xe7","\xa5","\xee"),null(),null());
	}
return null();
}

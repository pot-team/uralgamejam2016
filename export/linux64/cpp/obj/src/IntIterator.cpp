...
bool IntIterator_obj::hasNext( ){
	HX_STACK_FRAME("IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","/usr/share/haxe/std/IntIterator.hx",52,0x062523fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(53)
...
int IntIterator_obj::next( ){
	HX_STACK_FRAME("IntIterator","next",0x6932a124,"IntIterator.next","/usr/share/haxe/std/IntIterator.hx",61,0x062523fc)
	HX_STACK_THIS(this)
	HX_STACK_LINE(62)
	int tmp = (this->min)++;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(62)

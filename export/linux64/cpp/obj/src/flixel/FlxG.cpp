...
::openfl::display::FPS FlxG_obj::removeChild_openfl_display_FPS( ::openfl::display::FPS Child){
	HX_STACK_FRAME("flixel.FlxG","removeChild_openfl_display_FPS",0x4a309d8b,"flixel.FlxG.removeChild_openfl_display_FPS","flixel/FlxG.hx",427,0x8e176836)
	HX_STACK_ARG(Child,"Child")
	HX_STACK_LINE(428)
	::flixel::FlxGame tmp = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(428)
	::openfl::display::FPS tmp1 = Child;		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(428)
	...
	if ((tmp2)){
		...
		HX_STACK_LINE(430)
		::openfl::display::FPS tmp4 = Child;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(430)
		tmp3->removeChild(tmp4);
	}
	HX_STACK_LINE(432)
	::openfl::display::FPS tmp3 = Child;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(432)
	return tmp3;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,removeChild_openfl_display_FPS,return )

::openfl::display::FPS FlxG_obj::addChildBelowMouse_openfl_display_FPS( ::openfl::display::FPS Child,hx::Null< int >  __o_IndexModifier){
int IndexModifier = __o_IndexModifier.Default(0);
	HX_STACK_FRAME("flixel.FlxG","addChildBelowMouse_openfl_display_FPS",0x84662926,"flixel.FlxG.addChildBelowMouse_openfl_display_FPS","flixel/FlxG.hx",410,0x8e176836)
	HX_STACK_ARG(Child,"Child")
	HX_STACK_ARG(IndexModifier,"IndexModifier")
{
		...
		HX_STACK_LINE(411)
		::openfl::_legacy::display::Sprite tmp2 = tmp1->_inputContainer;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(411)
		int tmp3 = tmp->getChildIndex(tmp2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(411)
		...
		HX_STACK_LINE(412)
		int max = tmp5;		HX_STACK_VAR(max,"max");
		HX_STACK_LINE(414)
		int tmp6 = index;		HX_STACK_VAR(tmp6,"tmp6");
		HX_STACK_LINE(414)
		int tmp7 = IndexModifier;		HX_STACK_VAR(tmp7,"tmp7");
		HX_STACK_LINE(414)
		int tmp8 = max;		HX_STACK_VAR(tmp8,"tmp8");
		HX_STACK_LINE(414)
		int tmp9 = ::flixel::math::FlxMath_obj::maxAdd(tmp6,tmp7,tmp8,null());		HX_STACK_VAR(tmp9,"tmp9");
		HX_STACK_LINE(414)
		index = tmp9;
		HX_STACK_LINE(415)
		::flixel::FlxGame tmp10 = ::flixel::FlxG_obj::game;		HX_STACK_VAR(tmp10,"tmp10");
		HX_STACK_LINE(415)
		::openfl::display::FPS tmp11 = Child;		HX_STACK_VAR(tmp11,"tmp11");
		HX_STACK_LINE(415)
		int tmp12 = index;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(415)
		tmp10->addChildAt(tmp11,tmp12);
		HX_STACK_LINE(416)
		::openfl::display::FPS tmp13 = Child;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(416)
		return tmp13;
	}
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxG_obj,addChildBelowMouse_openfl_display_FPS,return )
...
bool FlxG_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 19:
		...
		break;
	case 30:
		if (HX_FIELD_EQ(inName,"removeChild_openfl_display_FPS") ) { outValue = removeChild_openfl_display_FPS_dyn(); return true;  }
		break;
	case 37:
		if (HX_FIELD_EQ(inName,"addChildBelowMouse_openfl_display_FPS") ) { outValue = addChildBelowMouse_openfl_display_FPS_dyn(); return true;  }
	}
	return false;
}
...
static ::String sStaticFields[] = {
	HX_HCSTRING("removeChild_openfl_display_FPS","\x04","\x56","\x16","\xa9"),
	HX_HCSTRING("addChildBelowMouse_openfl_display_FPS","\xcd","\x61","\xff","\x46"),

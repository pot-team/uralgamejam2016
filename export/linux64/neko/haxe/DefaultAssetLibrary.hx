...
@:sound("/home/biospore/haxelib/flixel/4,0,1/assets/sounds/beep.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_beep_ogg extends flash.media.Sound {}
@:sound("/home/biospore/haxelib/flixel/4,0,1/assets/sounds/flixel.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends flash.media.Sound {}
@:font("/home/biospore/haxelib/flixel/4,0,1/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/home/biospore/haxelib/flixel/4,0,1/assets/fonts/monsterrat.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends flash.text.Font {}
@:bitmap("/home/biospore/haxelib/flixel/4,0,1/assets/images/ui/button.png") @:keep #if display private #end class __ASSET__flixel_images_ui_button_png extends flash.display.BitmapData {}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/images/megha_knuckles_advance_sprite_sheet_by_tfpivman-d4qhlrb.png", AssetType.IMAGE);
		path.set ("assets/images/sanji.png", "assets/images/sanji.png");
		type.set ("assets/images/sanji.png", AssetType.IMAGE);
		path.set ("assets/images/tileset_grass_fall.png", "assets/images/tileset_grass_fall.png");
		type.set ("assets/images/tileset_grass_fall.png", AssetType.IMAGE);
		...
		type.set ("assets/xml/menu_state.xml", AssetType.TEXT);
		className.set ("flixel/sounds/beep.ogg", __ASSET__flixel_sounds_beep_ogg);
		type.set ("flixel/sounds/beep.ogg", AssetType.SOUND);
		className.set ("flixel/sounds/flixel.ogg", __ASSET__flixel_sounds_flixel_ogg);
		type.set ("flixel/sounds/flixel.ogg", AssetType.SOUND);
		...
		id = "assets/data/level_auto.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/gfx/ui/dark_grey.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/zoro_sprite_by_denpro-d5177ga.jpg";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tileset_player.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/auto_tiles.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/megha_knuckles_advance_sprite_sheet_by_tfpivman-d4qhlrb.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/sanji.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tileset_grass_fall.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/andi.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/sanji_sprite_sheet_by_nitrothart-d4hkepe.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/olala.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/free_16x16_tileset_by_neoz7-d8gs48c.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tileset_walls.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/xml/settings_state.xml";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/xml/_ui_globals.xml";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/xml/menu_state.xml";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
...
@:file("/home/biospore/haxelib/flixel/4,0,1/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.ByteArray {}
@:file("/home/biospore/haxelib/flixel/4,0,1/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.ByteArray {}
@:font("/home/biospore/haxelib/flixel/4,0,1/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("/home/biospore/haxelib/flixel/4,0,1/assets/fonts/monsterrat.ttf") #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
@:image("/home/biospore/haxelib/flixel/4,0,1/assets/images/ui/button.png") #if display private #end class __ASSET__flixel_images_ui_button_png extends lime.graphics.Image {}

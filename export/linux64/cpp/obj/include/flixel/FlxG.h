...
class HXCPP_CLASS_ATTRIBUTES  FlxG_obj : public hx::Object{
	...
	public:
		...
		static void __boot();
		static ::openfl::display::FPS removeChild_openfl_display_FPS( ::openfl::display::FPS Child);
		static Dynamic removeChild_openfl_display_FPS_dyn();

		static ::openfl::display::FPS addChildBelowMouse_openfl_display_FPS( ::openfl::display::FPS Child,hx::Null< int >  IndexModifier);
		static Dynamic addChildBelowMouse_openfl_display_FPS_dyn();
